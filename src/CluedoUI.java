...
public class CluedoUI {
    ...
    /**
     * Sets the board with weapons[default] and tokens which depends on the user
     * inputs
     */
    ...
    public String playerChoice() {
        String playerChoice = JOptionPane.showInputDialog("Please choose your character (see information panel)");
        return playerChoice;
    }
    ...
    /**
     * Method that converts an image into a jlabel object to easily place onto
     * the panel
     *
